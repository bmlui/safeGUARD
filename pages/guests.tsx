...
export default function Home() {
  ...
  const debouncedSearch = useMemo(
    () => lodash.debounce(setDebouncedSearchTerm, 300),
    []
  );
  useEffect(() => {
    ...
    () =>
      guests.filter(({ id }) =>
        id
          .toLowerCase()
          .replace(/[^A-Za-z]/g, "")
          .includes(debouncedSearchTerm.toLowerCase().replace(/[^A-Za-z]/g, ""))
      ),
      ...
      <div className="bg-gray-200 min-h-[550px] flex justify-center ">
        <div className="max-w-3xl w-full bg-white p-6 rounded-lg">
          ...
          <button
            ...
            className="ml-4 bg-slate-400 text-white py-2 px-4 rounded hover:bg-slate-500"
          >
            Clear
          </button>
